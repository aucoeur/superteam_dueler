...
def test_create_hero():
    ...
    input_values = ['Ben', '100', 'A', 'Amazing Ability', '100', 'W',
...
def test_build_team_one():
    input_values = ['Team 1', '1', 'Ben', '100', 'A', 'Amazing Ability', '100', 'W',
                    'Awesome Weapon', '200', 'R', 'Breastplate', '300', 'F']
...
def test_build_team_two():
    input_values = ['Team 2', '1', 'Steve', '100', 'A', 'Amazing Ability', '100', 'W',
                    'Awesome Weapon', '200', 'R', 'Breastplate', '300', 'F']
...
def test_team_stats():
    input_values = ['Team1', '1', 'Steve', '100', 'y', 'Amazing Ability', '10', 'n',
                    ...
                    'Team2', '2', 'Fivee', '100', 'y', 'Amazing Ability', '100', 'n',
                    'y', 'Amazing Weapon', '5000', 'n', 'y', 'God Armor', '500', 'n',
                    'Amazin', '100', 'y', 'Amazing Ability', '100', 'n',
                    'y', 'Amazing Weapon', '200', 'n', 'y', 'God Armor', '500', 'n']
